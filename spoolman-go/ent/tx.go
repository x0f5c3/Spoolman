...
func (tx *Tx) init() {
	tx.Filament = NewFilamentClient(tx.config)
	tx.FilamentField = NewFilamentFieldClient(tx.config)
...
// applies a query, for example: Filament.QueryXXX(), the query will be executed
